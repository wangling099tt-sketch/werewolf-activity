...
- Name: werewolf-ui.spec.cjs >> 🐺 MA SÓI - UI Mới >> 5. Chat box gửi tin nhắn
- Location: werewolf-ui.spec.cjs:75:3
...
Locator: locator('#chatLog > div').last()
Expected substring: "Vote đi mọi người!"
Timeout: 10000ms
Error: element(s) not found

Call log:
  - Expect "toContainText" with timeout 10000ms
  - waiting for locator('#chatLog > div').last()
...
- main:
  ...
  - complementary:
    ...
    - text: 1.2k Online
    - textbox "Nhập tin nhắn...": 🐺 Vote đi mọi người!
    - button "send"
```
