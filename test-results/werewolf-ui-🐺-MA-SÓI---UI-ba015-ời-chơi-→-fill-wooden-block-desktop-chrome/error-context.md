...
- Name: werewolf-ui.spec.cjs >> 🐺 MA SÓI - UI Mới >> 3. Thêm người chơi → fill wooden block
- Location: werewolf-ui.spec.cjs:48:3
...
Call log:
  - waiting for locator('#screen-room button:has-text("Thêm người chơi")')
    - locator resolved to <button onclick="simulateJoin()" class="mechanical-btn px-4 py-2 bg-tertiary text-on-tertiary rounded-lg font-bold text-sm flex items-center gap-2">…</button>
    ...
    - main [ref=e35]:
      - generic [ref=e36]:
        - generic [ref=e37]:
          ...
          - generic [ref=e40]:
            - button "add_circle TẠO PHÒNG" [active] [ref=e41] [cursor=pointer]:
