...
- Name: werewolf-ui.spec.cjs >> 🐺 MA SÓI - UI Mới >> 2. Click TẠO PHÒNG → Room screen với wooden blocks
- Location: werewolf-ui.spec.cjs:32:3
...
Call log:
  ...
  - waiting for locator('#screen-room')
    23 × locator resolved to <section id="screen-room" class="flex-1 flex-col gap-gutter lg:w-[70%] hidden">…</section>
...
- banner:
  - text: MA SÓI
  - button "Toggle Theme": light_mode
  - button "Settings": settings
  - button "Help": help
  - button "Account": account_circle
- navigation:
  - text: NC
  - heading "Người Chơi" [level=3]
  - paragraph: Cấp độ 15
  - link "home Trang chủ":
    - /url: "#"
  - link "swords Phòng chơi":
    - /url: "#"
  - link "group Bạn bè":
    - /url: "#"
  - link "shopping_bag Cửa hàng":
    - /url: "#"
  - button "Nâng cấp Premium"
  - link "settings Cài đặt":
    - /url: "#"
  - link "logout Đăng xuất":
    - /url: "#"
- main:
  - heading "MA SÓI" [level=1]
  - paragraph: Social Deduction Game
  - button "add_circle TẠO PHÒNG"
  - button "search TÌM PHÒNG"
  - heading "Phòng Đang Chờ" [level=2]
  - button "refresh Làm mới"
  - heading "Cửa Hàng Vật Phẩm" [level=2]
  - link "Xem tất cả arrow_forward":
    - /url: "#"
  - img "Nền Đêm Huyền Bí"
  - text: 500 Vàng
  - heading "Nền Đêm Huyền Bí" [level=3]
  - button "shopping_cart Mua"
  - img "Nền Sáng Bình Minh"
  - text: 500 Vàng
  - heading "Nền Sáng Bình Minh" [level=3]
  - button "shopping_cart Mua"
  - complementary:
    - heading "chat Kênh Thế Giới" [level=3]
    - text: 1.2k Online
